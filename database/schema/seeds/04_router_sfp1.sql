-- MikroTik SFP1 NAT router (160.187.175.26) → tenant_001
...
WHERE NOT EXISTS (SELECT 1 FROM tenant_001.devices WHERE host(device_ip) = '160.187.175.26');
...
WHERE NOT EXISTS (SELECT 1 FROM tenant_001.routers WHERE host(router_ip) = '160.187.175.26');
