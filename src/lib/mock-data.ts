import type { LogEntry, DashboardMetrics } from "@/lib/types";
...
export const DEMO_ADMIN_USERS = [
  {
    ...
    role: "Super Admin",
    last_login: "Today 03:47 PM",
    status: "Active",
  },
  {
    id: 2,
    username: "operator1",
    email: "ops@cyberlink.com",
    role: "Operator",
    last_login: "Today 10:22 AM",
    status: "Active",
  },
  {
    id: 3,
    username: "viewer_bd",
    email: "view@cyberlink.com",
    role: "Viewer",
