      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 p-5">
          <div>
            ...
            <div className="text-[10px] uppercase tracking-wider text-blue-300/70">Operator Portal</div>
          </div>
        ...
        <header className="border-b border-white/[0.07] bg-[#071525]/90 px-4 py-5 text-white backdrop-blur lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/40">Monitor networks and manage connections</p>
            </div>
          </div>
        </header>
        <motion.main
